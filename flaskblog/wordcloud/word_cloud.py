...
class WordCloudFromTweet:
    ...
    shape_path = 'flaskblog/static/shape/twitter_shape.jpg'
    font_path = 'flaskblog/static/font/GenShinGothic-Bold.ttf'
    ...
    def exclude_words(self, text, words):
        if '質問箱' in text or '_natalie' in text:
            return ''
    ...
    def draw_word_cloud(self, word_freq_dict):
        ...
        plt.axis("off")
        plt.savefig(f'flaskblog/static/wordcloud_{self.utc}.jpg', bbox_inches='tight')
